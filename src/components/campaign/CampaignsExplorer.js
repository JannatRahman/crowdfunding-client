...
export default function CampaignsExplorer() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="mb-8">
        <h1 className="text-3xl sm:text-4xl font-extrabold text-cf-dark tracking-tight">Explore Campaigns</h1>
        <p className="text-cf-brown font-medium mt-2">Discover amazing projects to support</p>
      </div>
